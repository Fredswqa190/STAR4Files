...
void refresh() {
  ...
  if (!bme.performReading()) {
    log("BME688 sensor was dropped; attempting to restart; attempting to restart");
    bme.begin();
    if (!bme.begin()) {
  ...
  if (!mcp.readThermocouple()) {
    log("MCP9601 sensor was dropped; attempting to restart; attempting to restart");
...
//-------------------------------------------------------- 
        ...
        //Column 1-21 (A-U) CSV
          ...
          myFile.print(TRsim.getTimeSecs()); myFile.print(",");
          myFile.print(TRsim.getTimeUsecs()); myFile.print(",");
          myFile.print(TRsim.getTimeSecs()); myFile.print(",");
          myFile.print(TRsim.getLatitude()); myFile.print(",");
          myFile.print(TRsim.getLongitude()); myFile.print(",");
          myFile.print(TRsim.getAltitude()); myFile.print(",");
          myFile.print(TRsim.getRoll()); myFile.print(",");
          myFile.print(TRsim.getPitch()); myFile.print(",");
          myFile.print(TRsim.getYaw()); myFile.print(",");
          myFile.print(TRsim.getAccelerationX()); myFile.print(",");
          myFile.print(TRsim.getAccelerationY()); myFile.print(",");
          myFile.print(TRsim.getAccelerationZ()); myFile.print(",");
          myFile.print(TRsim.getPressure()); myFile.print(",");
          myFile.print(TRsim.getCourse()); myFile.print(",");
          myFile.print(TRsim.getSpeed()); myFile.print(",");
          myFile.print(TRsim.getVelocityNorth()); myFile.print(",");
          myFile.print(TRsim.getVelocityEast()); myFile.print(",");
          myFile.print(TRsim.getVelocityDown()); myFile.print(",");
          myFile.print(TRsim.getDeclination()); myFile.print(",");
          myFile.print(TRsim.getNumSats()); myFile.print(",");
          myFile.print(TRsim.getGPSFix()); myFile.print(",");
...
pcaselect(0); 
  ...
  Serial.print("sensor 1: \t"); Serial.print(g_Value, 7);
...
pcaselect(1);
  ...
  Serial.print("sensor 2: \t"); Serial.print(g_Value2, 7);
...
pcaselect(2);
  ...
  Serial.print("sensor 3: \t"); Serial.print(g_Value3, 7);
...
pcaselect(3);
  ...
  Serial.print("sensor 4: \t"); Serial.print(g_Value4, 7);
...
pcaselect(4);
  ...
  Serial.print("sensor 5: \t"); Serial.print(g_Value5, 7);
...
pcaselect(5);
  ...
  Serial.print("sensor 6: \t"); Serial.print(g_Value6, 7);
...
pcaselect(6);
  ...
  Serial.print("sensor 7: \t"); Serial.print(g_Value7, 7);
...
pcaselect(7);
  ...
  Serial.print("sensor 8: \t"); Serial.print(g_Value8, 7);
...
//MCP9601 Thermocouple Amplifier: Columns 35-37 (AI-AK)
  ...
  Serial.print(mcp.readThermocouple()); Serial.print(", ");
  Serial.print(mcp.readAmbient()); Serial.print(", ");
  Serial.print(mcp.readADC() * 2); Serial.print(", ");
...
// Utilizing 7 decimal places for more precision
    ...
    myFile.print(g_Value,  7); myFile.print(",");
    myFile.print(g_Value2, 7); myFile.print(",");
    myFile.print(g_Value3, 7); myFile.print(",");
    myFile.print(g_Value4, 7); myFile.print(",");
    myFile.print(g_Value5, 7); myFile.print(",");
    myFile.print(g_Value6, 7); myFile.print(",");
    myFile.print(g_Value7, 7); myFile.print(", ");
    myFile.print(g_Value8, 7); myFile.print(", \t");
    myFile.print(bme.temperature); myFile.print(", ");
    myFile.print(bme.pressure); myFile.print(", ");
    myFile.print(bme.humidity); myFile.print(", ");
    myFile.print(bme.gas_resistance); myFile.print(", ");
    myFile.print(bme.readAltitude(SEALEVELPRESSURE_HPA)); myFile.print(", ");
    myFile.print(mcp.readThermocouple()); myFile.print(", ");
    myFile.print(mcp.readAmbient()); myFile.print(", ");
    myFile.print(mcp.readADC() * 2); myFile.print(", ");
